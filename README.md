...
| [CoreMIDI In](CoreMIDI/) | CHOP | **Tempo and timecode from a DAW.** Turns MIDI Clock into `bpm` / `beat` and decodes MTC — TD gives you neither. Same UniqueID + hot-plug handling |
