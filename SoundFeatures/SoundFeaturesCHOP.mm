...
extern "C"{DLLEXPORT void FillCHOPPluginInfo(CHOP_PluginInfo*i){if(!i->setAPIVersion(CHOPCPlusPlusAPIVersion))return;i->customOPInfo.opType->setString("Soundfeatures");i->customOPInfo.opLabel->setString("Sound Features");i->customOPInfo.opIcon->setString("SFT");if(i->customOPInfo.opHelpURL)i->customOPInfo.opHelpURL->setString("https://github.com/sygnalinc/TDAppleOps/blob/main/SoundFeatures/README.md");i->customOPInfo.authorName->setString("SYGNAL Inc.");
