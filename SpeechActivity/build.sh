...
clang++ -std=c++17 -fobjc-arc -O2 -bundle -fmodules-cache-path="$PWD/build/module-cache" -I "$SDK" SpeechActivityCHOP.mm -framework Foundation -L "$OUT/Frameworks" -lVoiceActivityHelper -Xlinker -rpath -Xlinker @loader_path/../Frameworks -o "$OUT/MacOS/$NAME"
