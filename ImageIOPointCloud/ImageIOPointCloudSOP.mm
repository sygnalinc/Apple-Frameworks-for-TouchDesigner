...
DLLEXPORT void FillSOPPluginInfo(SOP_PluginInfo* i) {
    ...
    if (i->customOPInfo.opHelpURL) i->customOPInfo.opHelpURL->setString("https://github.com/sygnalinc/Apple-Frameworks-for-TouchDesigner/blob/main/ImageIOPointCloud/README.md");
