...
namespace {
class AudioToolboxMixCHOP final : public CHOP_CPlusPlusBase {
public:
    AudioToolboxMixCHOP(const OP_NodeInfo*) {}
    ~AudioToolboxMixCHOP() override { @autoreleasepool { teardown(); } }
...
private:
    ...
    bool ensureEngine(double sr, int maxFrames) {
        ...
        __block AudioToolboxMixCHOP* self_=this;
...
DLLEXPORT void DestroyCHOPInstance(CHOP_CPlusPlusBase* i) { delete static_cast<AudioToolboxMixCHOP*>(i); }
}
