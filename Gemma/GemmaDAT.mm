...
extern "C" {
DLLEXPORT void FillDATPluginInfo(DAT_PluginInfo*i){if(!i->setAPIVersion(DATCPlusPlusAPIVersion))return;i->customOPInfo.opType->setString("Gemma");i->customOPInfo.opLabel->setString("Gemma");i->customOPInfo.authorName->setString("SYGNAL Inc.");i->customOPInfo.opIcon->setString("GEM");if(i->customOPInfo.opHelpURL)i->customOPInfo.opHelpURL->setString("https://github.com/sygnalinc/TDAppleOps/blob/main/Gemma/README.md");i->customOPInfo.minInputs=0;i->customOPInfo.maxInputs=0;}
