...
FillDATPluginInfo(DAT_PluginInfo* info)
{
    ...
    if (info->customOPInfo.opHelpURL) info->customOPInfo.opHelpURL->setString("https://github.com/sygnalinc/Apple-Frameworks-for-TouchDesigner/blob/main/CoreMLDAT/README.md");
