...
build_one() {
  ...
  clang++ -std=c++17 -fobjc-arc -O2 -bundle -I "$SDK" "$SRC" \
...
build_one PDFDocumentDAT PDFDocumentDAT.mm "$SDK_DAT" pdfdocument-dat
build_one PDFDocumentTOP PDFDocumentTOP.mm "$SDK_TOP" pdfdocument-top
