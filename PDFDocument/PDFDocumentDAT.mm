...
namespace {
class PDFDocumentDAT final : public DAT_CPlusPlusBase {
public:
    PDFDocumentDAT(const OP_NodeInfo*) {}
    ~PDFDocumentDAT() override {}
...
DLLEXPORT DAT_CPlusPlusBase* CreateDATInstance(const OP_NodeInfo* i) { return new PDFDocumentDAT(i); }
DLLEXPORT void DestroyDATInstance(DAT_CPlusPlusBase* i) { delete static_cast<PDFDocumentDAT*>(i); }
}
