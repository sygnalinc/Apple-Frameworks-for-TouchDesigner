...
class GameplayAgentsCHOP final : public CHOP_CPlusPlusBase {
public:
    GameplayAgentsCHOP(const OP_NodeInfo*) { myTarget = [[GKAgent2D alloc] init]; }
    ~GameplayAgentsCHOP() override { @autoreleasepool { myAgents=nil; myTarget=nil; myBehavior=nil; } }
...
DLLEXPORT void FillCHOPPluginInfo(CHOP_PluginInfo* i) {
    ...
    i->customOPInfo.opType->setString("Gameplayagents");
    i->customOPInfo.opLabel->setString("Gameplay Agents");
...
DLLEXPORT CHOP_CPlusPlusBase* CreateCHOPInstance(const OP_NodeInfo* i) { return new GameplayAgentsCHOP(i); }
DLLEXPORT void DestroyCHOPInstance(CHOP_CPlusPlusBase* i) { delete static_cast<GameplayAgentsCHOP*>(i); }
}
