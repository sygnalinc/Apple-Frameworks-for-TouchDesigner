...
namespace {
class GameplayKitPathSOP final : public SOP_CPlusPlusBase {
public:
    GameplayKitPathSOP(const OP_NodeInfo*) {}
    ~GameplayKitPathSOP() override {}
...
DLLEXPORT void DestroySOPInstance(SOP_CPlusPlusBase* i) { delete static_cast<GameplayKitPathSOP*>(i); }
}
